...
export const useCloudProfileStore = defineStore('cloudProfile', () => {
  ...
  function setNamespacedCloudProfiles (namespacedCloudProfiles, namespace = null) {
    ...
    // Legacy behavior for callers that do not provide a namespace.
    namespacedListsByNamespace.value = {
      __legacy__: rehydrated,
    }
    namespacedList.value = rehydrated
  }
